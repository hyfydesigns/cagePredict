      ...
      <div className="container mx-auto px-4 py-10 max-w-3xl">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-6">
          ...
          <div className="space-y-1.5">
            ...
            <p className="text-foreground-muted text-xs pl-0.5">
          ...
          <nav className="flex flex-wrap gap-x-6 gap-y-2 text-sm text-foreground-muted">
            ...
            <Link href="/privacy" className="hover:text-foreground-secondary transition-colors">Privacy</Link>
            <Link href="/terms"   className="hover:text-foreground-secondary transition-colors">Terms</Link>
          </nav>
        </div>

        {/* Bottom row */}
        <div className="mt-8 pt-6 border-t border-border/40 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-2 text-xs text-foreground-muted">
