...
function FightCardSkeleton() {
  return (
    <div className="rounded-2xl overflow-hidden border border-zinc-800/60 bg-gradient-to-b from-zinc-900 to-[#0d0d0d]">
      {/* Header bar */}
      ...
      {/* Bottom bar */}
      <div className="border-t border-zinc-800/40 grid grid-cols-2">
        <div className="py-2 flex justify-center">
          <Skeleton className="h-3 w-24" />
        </div>
        <div className="py-2 flex justify-center border-l border-zinc-800/40">
